  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-900 p-8 overflow-y-auto">
      <div className="max-w-3xl w-full bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700 p-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="grid grid-cols-2 gap-6 mb-8 mt-8"><div className="p-6 bg-slate-50 dark:bg-slate-700 rounded-2xl"><div className="text-4xl font-bold text-indigo-600 mb-1">{score}</div><div className="text-sm font-medium text-slate-600 dark:text-white">Total Score</div></div><div className="p-6 bg-slate-50 dark:bg-slate-700 rounded-2xl"><div className="text-4xl font-bold text-emerald-600 mb-1">{percentage}%</div><div className="text-sm font-medium text-slate-600 dark:text-white">Accuracy</div></div></div>
